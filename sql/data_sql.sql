...
CREATE TABLE `du_admin_users` (
  ...
  `delete_time` int(50) DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- 转存表中的数据 `du_admin_users`
--

INSERT INTO `du_admin_users` (`id`, `username`, `password`, `avatar`, `email`, `email_code`, `phone`, `status`, `register_time`, `last_login_ip`, `last_login_time`, `delete_time`) VALUES
(88, 'admin', '8de6e5de92ac4beebabde01bbb9da167', '/Upload/avatar/user1.jpg', '', '', NULL, 1, 1449199996, '', 0, NULL),
(89, 'ces', 'sadfasfas asfd', 'dsafasf', 'safasf', NULL, NULL, 2, 0, 'asdfda', 111, NULL),
(103, '李四', 'lisi', '', '', NULL, NULL, 1, 0, '', 1600246390, NULL),
(104, '张三', 'zhangshan', '', '', NULL, NULL, 2, 0, '', 1600246094, NULL),
(105, '李四', 'lisi', '', '', NULL, NULL, 1, 0, '', 1600246374, 1600252154),
(109, '李四', 'lisi', '', '', NULL, NULL, 1, 0, '', 1600246375, NULL),
(111, '李四', 'lisi', '', '', NULL, NULL, 1, 0, '', 1600246376, NULL);

-- --------------------------------------------------------

--
-- 表的结构 `du_alipay_order`
--

CREATE TABLE `du_alipay_order` (
  `id` int(10) UNSIGNED NOT NULL COMMENT '支付宝回执单主键id',
...
CREATE TABLE `du_faq` (
  ...
  `type` int(20) NOT NULL COMMENT '类型1tts,2邮件，3字幕',
  `content` text NOT NULL,
  `create_time` int(200) NOT NULL
...
--
-- 表的结构 `du_province_city_area`
--

CREATE TABLE `du_province_city_area` (
...
--
-- 转存表中的数据 `du_province_city_area`
--

INSERT INTO `du_province_city_area` (`id`, `pid`, `name`) VALUES
(1, 0, '北京'),
(2, 1, '北京市辖'),
(3, 2, '东城区'),
(4, 2, '西城区'),
...
--
-- 表的结构 `du_send_content`
--

CREATE TABLE `du_send_content` (
  `id` int(15) NOT NULL,
...
INSERT INTO `du_status_code` (`id`, `code`, `status`, `describe`, `wait_second`, `delete_time`) VALUES
(1, 100001, 1, '成功', 1, NULL),
(2, 400001, 0, 'ERROR:失败', 3, NULL),
(3, 400012, 0, '删除失败：子菜单包含数据，请先删除子菜单数据', 3, NULL),
(4, 420001, 0, '提交失败', 3, NULL),
(5, 420002, 0, '提交失败：数据错误', 3, NULL),
(6, 1, 1, '成功', 3, NULL),
(7, 0, 0, 'ERROR：失败', 3, NULL),
(8, 100002, 1, '注册成功', 3, NULL),
(9, 100011, 1, '修改成功', 1, NULL),
(10, 100012, 1, '添加成功', 1, NULL),
(11, 500011, 5, '警告：值不能为空', 3, NULL),
(12, 400011, 0, 'ERROR：删除失败', 3, NULL),
(13, 100013, 1, '删除成功', 1, NULL),
(14, 404, 4, '页面不存在', 3, NULL),
(15, 100003, 1, '登录成功，请稍后...', 3, NULL),
(16, 100021, 1, '数据恢复成功', 3, NULL),
(17, 420221, 0, '数据恢复失败', 3, NULL),
(18, 420011, 0, '修改失败.', 3, NULL),
(19, 100004, 1, '注销登录成功，请稍后...', 3, NULL),
(20, 420104, 0, '注销登录失败！', 3, NULL),
(21, 300001, 0, '您没有权限访问', 3, NULL),
(22, 420101, 0, '登录信息过期，请重新登录', 3, NULL),
(23, 400013, 0, '删除失败：包含子权限，请先删除子权限', 3, NULL),
(24, 420103, 0, '账号密码错误', 3, NULL),
(25, 420102, 0, '尚未登录，请登录后再试', 3, NULL),
(26, 420105, 0, '验证码错误', 2, NULL),
(27, 420301, 0, '添加失败，已经存在', 2, NULL);
...
-- 表的索引 `du_admin_users`
--
ALTER TABLE `du_admin_users`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_login_key` (`username`) USING BTREE;

--
-- 表的索引 `du_alipay_order`
--
ALTER TABLE `du_alipay_order`
  ADD PRIMARY KEY (`id`);
...
--
-- 表的索引 `du_province_city_area`
--
ALTER TABLE `du_province_city_area`
  ADD PRIMARY KEY (`id`);

--
-- 表的索引 `du_send_content`
--
ALTER TABLE `du_send_content`
  ADD PRIMARY KEY (`id`);
...
--
-- 使用表AUTO_INCREMENT `du_admin_users`
--
ALTER TABLE `du_admin_users`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=113;

--
-- 使用表AUTO_INCREMENT `du_alipay_order`
--
ALTER TABLE `du_alipay_order`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '支付宝回执单主键id', AUTO_INCREMENT=140;
...
--
-- 使用表AUTO_INCREMENT `du_province_city_area`
--
ALTER TABLE `du_province_city_area`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键', AUTO_INCREMENT=3511;

--
-- 使用表AUTO_INCREMENT `du_send_content`
--
ALTER TABLE `du_send_content`
