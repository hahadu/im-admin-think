...
use Hahadu\ThinkAdmin\Contract\MessageBagContract;
use Hahadu\ThinkAdmin\Contract\MessageProvider;
...
class MessageBag implements Jsonable, JsonSerializable, MessageBagContract, MessageProvider
{
    ...
    protected function getMessagesForWildcardKey($key, $format)
    {
        return collect($this->messages)
            ->filter(function ($messages, $messageKey) use ($key) {
                return $this->strIs($key, $messageKey);
            })
     ...
     * @return bool
     */
    protected function strIs($pattern, $value)
    {
