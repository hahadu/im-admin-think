...
namespace Hahadu\ThinkAdmin\Widgets;

use Hahadu\ThinkAdmin\Widgets\Navbar\RefreshButton;
use Hahadu\ThinkAdmin\Contract\Htmlable;
...
class Navbar implements Renderable
{
    ...
    {
        $this->elements = [
            'left'  => Collection::make(),
            'right' => Collection::make(),
        ];
    }
    ...
    public function render($part = 'right')
    {
        ...
        $render = $this->elements[$part]->map(function ($element) {
